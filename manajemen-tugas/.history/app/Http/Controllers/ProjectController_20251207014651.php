...
class ProjectController extends Controller
{
    public function index()
    {
        ...
        // Update progress dan status setiap proyek
    ...
    public function store(Request $request)
    {
        ...
        // Status dan progress akan otomatis diatur oleh sistem
        $project = Project::create([
            'nama' => $request->nama,
            'deskripsi' => $request->deskripsi,
            'tanggal_mulai' => $request->tanggal_mulai,
            'tanggal_selesai' => $request->tanggal_selesai,
            'status' => 'Belum Mulai', // Default awal
            'progress' => 0, // Default awal
            'user_id' => auth()->id(),
        ]);
    ...
    public function show($id)
    {
        ...
        // Update progress dan status sebelum ditampilkan
        $project->updateProgress();
    ...
    public function update(Request $request, $id)
    {
        ...
        // Hanya update data yang bisa diubah manual
        // Status dan progress akan otomatis diatur oleh sistem
        $project->update([
            'nama' => $request->nama,
            'deskripsi' => $request->deskripsi,
        ...
        // Update progress dan status otomatis setelah edit
        $project->updateProgress();
